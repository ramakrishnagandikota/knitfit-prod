...
$('.edit-info2').hide();
    ...
    $('#edit-cancel').on('click', function() {
        ...
        c.addClass('fa-pencil');
		$('.edit-info').hide();
        $('.view-info').show();
    });
	
	$('#edit-cancel1').on('click', function() {

        var c = $('#edit-btn2').find("i");
        c.removeClass('icofont-close');
        c.addClass('fa-pencil');
		$('.edit-info2').hide();
		$('.view-info2').show();
	...
	$('#edit-cancel3').on('click', function() {

        var c = $('#edit-btn3').find("i");
        c.removeClass('icofont icofont-close');
        c.addClass('fa fa-pencil');
		$('.edit-info3').hide();
		$('.view-info3').show();
    });
    ...
    $('#edit-btn').on('click', function() {
        ...
        if (edit_class == 'fa fa-pencil') {
            b.removeClass('fa fa-pencil');
            b.addClass('icofont icofont-close');
            $('.view-info').hide();
            $('.edit-info').show();
        } else {
            b.removeClass('icofont icofont-close');
            b.addClass('fa fa-pencil');
            $('.view-info').show();
            $('.edit-info').hide();
        }
    });
