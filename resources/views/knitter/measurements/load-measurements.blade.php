		...
		<div class="col-lg-12 col-xl-12 col-md-9">
            <div class="card custom-card skew-card">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                    	<a href="#" >  
                    		<a href="{{url('knitter/measurements')}}" class="btn waves-effect m-t-10 m-r-20 pull-right waves-light btn-primary theme-outline-btn" ><i class="icofont icofont-plus"></i>Create Measurement</a>
                    	</a>
                    </div>
                </div>
