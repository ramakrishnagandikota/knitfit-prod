...
<form class="md-float-material form-material" method="POST" action="{{url('register')}}" autocomplete="no">
    ...
    <div class="auth-box card">
        <div class="card-block custom-padding">
            ...
            <div class="row m-b-5">
                <div class="col-sm-6">
                    <div class="form-group form-primary">
                        ...
                        <i class="fa fa-info pophover" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="First Name should contain only Alphabets and supports maximum lenght 25 characters"></i>
                ...
                <div class="col-sm-6">
                    <div class="form-group form-primary">
                        ...
                        <i class="fa fa-info pophover" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Last Name should contain only Alphabets and supports maximum lenght 15 characters"></i>
                        <span class="form-bar"></span>
                ...
                <div class="col-md-12">
                    <div class="checkbox-fade fade-in-primary">
                        <label class="micro-label">
                            ...
                            <span class="text-inverse">I read and accept <a href="#" class="micro-label" style="color:#0d665c"><u>Terms &amp; Conditions</u>.</a></span>
                            <br>
            ...
            <div class="row">
                <div class="col-md-10">
                    <p class="text-inverse text-left m-b-0">back to <a href="{{url('login')}}" style="color: #0d665c"><b>Login</b></a></p>
                </div>
                <!-- <div class="col-md-2">
