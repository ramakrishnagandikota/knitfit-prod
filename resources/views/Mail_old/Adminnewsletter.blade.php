                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 20px; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <div style="line-height: 35px">
                               ...
                               Hello Admin ,
                               You have received a subscription notification from 
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 20px; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <div style="line-height: 35px">
                                ...
                                Name : @if($details1['name']) {{$details1['name']}} @else No Name @endif
                            ...
                            <table border="0" width="400" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; line-height: 24px;">
                                       ...
                                       To Unscbscribe notifications for this user, please login to admin panel & click on newsletter subscriptions.
                                        </div>
                                    </td>
                                </tr>
                            </table>
